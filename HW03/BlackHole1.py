...
while idx <(len(X)-1):  #iterate over data values
    ...
    p_init = vector(star.m * Xvel[idx-1],star.m * Yvel[idx-1],0)
    p_final = vector(star.m * Xvel[idx],star.m * Yvel[idx],0)
    ...
    arrowscale = 0.5e-17      # determines how long to draw the arrows that represent vectors
